...
class InsuredCardCategory(models.Model):
    ...
    child_ids = fields.One2many('myo.insured.card.category', 'parent_id', 'Child Categories')
    ...
    def name_get(self):
        ...
        if self._context.get('category_display') == 'short':
            return super(InsuredCardCategory, self).name_get()
