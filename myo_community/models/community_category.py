...
class CommunityCategory(models.Model):
    ...
    parent_id = fields.Many2one('myo.community.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    def name_get(self):
        ...
        if self._context.get('category_display') == 'short':
            return super(CommunityCategory, self).name_get()
