...
class PersonCategory(models.Model):
    _name = 'myo.person.category'

    name = fields.Char('Category', required=True, translate=True)
    parent_id = fields.Many2one('myo.person.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('myo.person.category', 'parent_id', 'Child Categories')
