...
class EventCategory(models.Model):
    ...
    child_ids = fields.One2many('myo.event.category', 'parent_id', 'Child Categories')
    ...
    def name_get(self):
        ...
        if self._context.get('category_display') == 'short':
            return super(EventCategory, self).name_get()
